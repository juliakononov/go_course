...
func (x *SearchReply) GetComics() []*ComicsInfo {
	if x != nil {
		return x.Comics
	}
	return nil
...
const file_proto_search_search_proto_rawDesc = "" +
	...
	"\vSearchReply\x12*\n" +
	"\x06comics\x18\x01 \x03(\v2\x12.search.ComicsInfoR\x06comics2z\n" +
	"\x06Search\x128\n" +
